...
export function PowerManagementPanel({
  ...
  // Click handler para el bloque minimo (componentes con powerMin: escudos,
  // radares). Asigna/quita la energia minima del componente. NO subdivide ni
  // togglea hardpoints individuales (eso causaba 'apagar el de arriba').
          ...
          <div className="space-y-1">
            ...
            <div className="flex" style={{ gap: "2px", justifyContent: "center" }}>
              {columns.map((inst, colIdx) => {
                ...
                // Componentes con powerMin (escudos, radares) muestran sus pips
                // minimos como un unico bloque; las armas (sin minimo) muestran
                // pips individuales.
