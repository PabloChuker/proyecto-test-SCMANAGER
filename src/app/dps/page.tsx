...
const SIDEBAR_ITEMS = [
  { key: "dps", href: "/dps", label: "DPS Calculator", icon: "/media/icons/DPS_calculator.png" },
  { key: "ships", href: "/components?tab=ships", label: "Ships", icon: "/media/icons/Ships.png" },
  { key: "weapons", href: "/components?tab=weapons", label: "Weapons", icon: "/media/icons/weapons.png" },
  { key: "missiles", href: "/components?tab=missiles", label: "Missiles", icon: "/media/icons/missile.png" },
  { key: "emps", href: "/components?tab=emps", label: "EMP Generators", icon: "/media/icons/emp.png" },
  { key: "shields", href: "/components?tab=shields", label: "Shields", icon: "/media/icons/shilds.png" },
  { key: "power_plants", href: "/components?tab=power_plants", label: "Power Plants", icon: "/media/icons/power_plants.png" },
  { key: "coolers", href: "/components?tab=coolers", label: "Coolers", icon: "/media/icons/coolers.png" },
  { key: "quantum_drives", href: "/components?tab=quantum_drives", label: "Quantum Drives", icon: "/media/icons/Quantum_drives.png" },
  { key: "qed", href: "/components?tab=qed", label: "QED Generators", icon: "/media/icons/interdict_pulse.png" },
  { key: "mining", href: "/components?tab=mining", label: "Mining Lasers", icon: "/media/icons/mining_lasers.png" },
  { key: "turrets", href: "/components?tab=turrets", label: "Turrets", icon: "/media/icons/weapons.png" },
];
