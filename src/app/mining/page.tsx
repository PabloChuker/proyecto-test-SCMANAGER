...
const TABS = [
  { id: "loadout", label: "Loadout Calculator", icon: "ÔÜÖ" },
  { id: "workorder", label: "Work Order", icon: "­ƒôè" },
  { id: "rock", label: "Rock Calculator", icon: "­ƒ¬¿" },
  { id: "refinery", label: "Refinery Data", icon: "­ƒÅ¡" },
];
