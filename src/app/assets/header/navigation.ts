...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // Oculto temporalmente hasta que Pablo dé el OK para abrirlo al público.
      // La página sigue accesible vía URL directa y desde el endpoint admin.
  ...
  },
  {
    ...
    items: [
      ...
      { label: "CCU Chains",      href: "/hangar/chain-board" },
      { label: "Cadenas comunidad", href: "/hangar/chain-board/community" },
    ],
  },
  {
    key: "tools",
